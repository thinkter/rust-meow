...
- protocol v21 and attachment, poll, pinned-message, forward, edit, persisted sync-status, on-demand history, integrity, repair, and Agent Control RPCs are wired through the Go backend,
