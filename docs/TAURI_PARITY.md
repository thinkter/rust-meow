...
- protocol v20 and attachment, poll, pinned-message, forward, edit, persisted sync-status, on-demand history, integrity, and repair RPCs are wired through the Go backend,
