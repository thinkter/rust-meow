---
name: whatsapp-remote-session
description: Run a Codex task initiated through Rust Meow's allowlisted WhatsApp control channel. Use only when Rust Meow explicitly supplies this skill for a remote session.
---
